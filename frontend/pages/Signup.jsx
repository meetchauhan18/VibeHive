...
export const Signup = () => {
  ...
  return (
    <div className="signup-container flex flex-col justify-center items-center h-auto w-full bg-[#e6e6e6] gap-10 py-10 overflow-y-auto overflow-x-auto">
      <div className="form-container flex flex-row justify-center items-center h-auto w-full gap-5 px-30">
        <div className="screen-img-container h-170 w-1/2 bg-red-500 rounded-md shadow-2xl">
          SHARE YOUR MEMORIES
        </div>
        <form
        onSubmit={handleSubmit}
        className="signup-form flex flex-col items-center justify-center bg-white rounded-md h-auto w-92 gap-4 p-10 shadow-2xl"
      >
